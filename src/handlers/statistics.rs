...
impl StatisticsAggregator {
    pub fn new(db: Arc<Connection>) -> Self {
        ...
        Self { 
            db,
            location_metrics_aggregator: LocationMetricsAggregator::new(db_clone),
        }
    }
...
impl LocationMetricsAggregator {
    ...
    pub async fn remove_unused_active_aggregated_metrics(&self, thirty_minutes_ago_ts: i64) -> Result<(), tokio_rusqlite::Error> {
        self.db.call(move |conn| {
